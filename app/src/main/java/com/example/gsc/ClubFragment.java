...
public class ClubFragment extends Fragment {
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mclublist.add(new ClubList(R.drawable.graphex_club_logo_dark,"Graphex",getString(R.string.About_Club),"Ankur pal","Ayush upadhyay","palankur891@gmail.com","uayush600@gmail.com","8448661167","8765910889"));
